...
const navigate = useNavigate();
    ...
    return <Card className=" hover:cursor-pointer hover:shadow-lg !rounded-lg">
                        <CardContent>
                           ...
                           <CardMedia component="img" className="h-56 rounded-md object-fit-cover object-center" src={item.image} alt={item.name} />
                            ...
                            <div className="py-2">
                              ...
                              <div>
                                ...
                                <Button onClick={()=>navigate(`/edit/${item._id} `)} variant="outlined" > Edit </Button>
                                </div>
                            </div>
                        </CardContent>
                </Card>
