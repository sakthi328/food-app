              ...
              <div style={{display:"flex", width:"100%", alignItems:"center", justifyContent:"space-between"}}>
                  ...
                  <List sx={{display:"flex", flexWrap:'nowrap', gap:1, }}>
                    ...
                    <ListItem  component={Link}>
                        ...
                        <ListItemText sx={itemColor} className="overflow-visible whitespace-nowrap overflow-ellipsis hover:!text-red-700 !font-bold" onClick={() => navigate('/my-todo')} primary="Todo" />
                        </ListItem>
                    <ListItem component={Link}>
                        <ListItemText sx={itemColor} className="overflow-visible whitespace-nowrap overflow-ellipsis  hover:!text-red-700 !font-bold" onClick={() => navigate('/create')} primary="Create"/>
                    </ListItem>
                    <ListItem component={Link}>
